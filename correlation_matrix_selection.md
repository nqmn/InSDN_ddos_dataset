...
In HLD-DDoSDN and LR-HR, they yield identical accuracy, indicating that both methods perform equally well, but not necessarily that the relationships are linear.

Silhouette score is used to evaluate the cluster separability of the feature generated by the DFA algorithm. A higher silhouette score means better-defined clusters.
